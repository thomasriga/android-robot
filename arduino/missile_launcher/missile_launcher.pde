...
char accessoryName[] = "AndroidRobot"; // your Arduino board
char companyName[] = "thomasriga.com";

//AndroidAccessory acc(companyName, accessoryName);
...
void detect_faces() {
  ...
  if (acc.isConnected()) {
    ...
    //suggested_dir = acc.read();
    //suggested_tilt_dir = acc.read();
  }
  else {
...
void pull_trigger() {
  trigger_servo.write(110);
}

void release_trigger() {
  trigger_servo.write(62);
}
